...
# GTFS PubSub Backend for Open Transit

A self-contained daemon or service model designed to subscribe to static and real-time General Transit Feed Specification (GTFS) data from remote service(s) providers.

The subscribed data is consumed, stored, and made available to internal services and applications with the Open Transit domain and perhaps beyond.
