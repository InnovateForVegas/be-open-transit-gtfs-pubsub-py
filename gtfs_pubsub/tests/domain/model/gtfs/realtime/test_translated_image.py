...
from gtfs_pubsub.domain.model.gtfs.realtime.localized_image import LocalizedImageForeignData
import pytest

def test_TranslatedImageForeignData_valid_minimum():
	li = LocalizedImageForeignData(url="https://localizedimage.com")
	t = TranslatedImageForeignData(localized_image=li)
