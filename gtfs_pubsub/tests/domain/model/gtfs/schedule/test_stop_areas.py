...
from gtfs_pubsub.domain.model.gtfs.schedule.stop_areas import StopAreasForeignData
import pytest

def test_StopAreasForeignData_valid():
	s = StopAreasForeignData(
		area_id=123, stop_id=234
	)
	assert s is not None

def test_StopAreasForeignData_missing_area_id():
