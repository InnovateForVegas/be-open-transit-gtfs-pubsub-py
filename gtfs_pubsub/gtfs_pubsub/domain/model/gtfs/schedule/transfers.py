...
from gtfs_pubsub.domain.model.gtfs.gtfs_types import ID, Enum, Integer

class TransfersForeignData(BaseModel):
	from_stop_id: ID | None
	to_stop_id: ID | None
	from_route_id: ID | None
	to_route_id: ID | None
	from_trip_id: ID | None
	to_trip_id: ID | None
	transfer_type: Enum
