...
from gtfs_pubsub.domain.model.gtfs.gtfs_types import ID, Integer, Enum

class FareTransferRulesForeignData(BaseModel):
	from_leg_group_id: ID | None
	to_leg_group_id: ID | None
	transfer_count: Integer | None
	duration_limit: Integer | None
	duration_limit_type: Enum | None
	fare_transfer_type: Enum | None
	fare_product_id: ID


@dataclass
class FareTransferRulesData:
