...
from gtfs_pubsub.domain.model.gtfs.gtfs_types import ID, Text, WheelchairAccessibleEnum

class VehicleDescriptorForeignData(BaseModel):
  id: ID | None
  label: Text | None
  license_plate: Text | None
  wheelchair_accessible: WheelchairAccessibleEnum | None
