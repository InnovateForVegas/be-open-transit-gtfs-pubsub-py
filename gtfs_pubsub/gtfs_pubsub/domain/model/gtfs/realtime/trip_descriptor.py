...
from gtfs_pubsub.domain.model.gtfs.gtfs_types import Text, Time, Date, Integer, TripScheduleRelationshipEnum

class TripDescriptorForeignData(BaseModel):
	trip_id: Text | None
	route_id: Text | None
	direction_id: Integer | None
	start_time: Time | None
	start_date: Date | None
	schedule_relationship: TripScheduleRelationshipEnum | None
