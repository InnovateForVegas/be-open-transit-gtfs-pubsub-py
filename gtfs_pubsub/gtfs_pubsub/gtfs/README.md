...
Implement documented GTFS data structure interfaces including

- Data parsing on subscription consumption
  - Schedule data is grouped CSV in a ZIP file
  - Realtime data is a protobuf to be deserialized and parsed
- Standard output formation on publication
