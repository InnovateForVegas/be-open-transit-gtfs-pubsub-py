...
# Driving Adaptor Implementations

These are incoming adaptors on the left side of the hexagonal architecture, implementing the driving port interfaces as needed for particular use cases.
