...
# Driven Adaptor Implementations

These are outgoing adaptors on the right side of the hexagonal architecture, implementing the driven port interfaces as needed for particular use cases.
